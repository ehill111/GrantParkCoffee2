...
namespace GrantParkCoffeeShop2.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CustomerId,IdentityUserId,FirstName,LastName,StreetAddress,City,State,ZipCode,Email,RewardPointsBalance")] Customer customer)
        {
